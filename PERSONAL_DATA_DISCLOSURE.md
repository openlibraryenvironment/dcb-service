...
The purpose of this form is to disclose the types of personal data[^1] (PD) stored by a module.  This information enables those hosting systems to better manage and comply with various privacy laws and restrictions, e.g. GDPR.
