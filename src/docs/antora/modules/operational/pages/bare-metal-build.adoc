...
DCB is a Micronaut application compiled as a Java 25 source. The project itself has gradle wrapper installed, so no external gradle installation is necessary.
