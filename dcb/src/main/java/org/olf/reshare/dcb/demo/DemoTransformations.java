...
/**
 * Factory that houses any Transformers we wish to register, with the transformation
 * service. This particular factory is only active when the application is started with
 * the under the "demo" environment. 
 * 
