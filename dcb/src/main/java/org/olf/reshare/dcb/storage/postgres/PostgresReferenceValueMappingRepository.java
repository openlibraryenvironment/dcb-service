...
@Transactional
public interface PostgresReferenceValueMappingRepository extends ReactiveStreamsPageableRepository<ReferenceValueMapping, UUID>, ReferenceValueMappingRepository {
}
