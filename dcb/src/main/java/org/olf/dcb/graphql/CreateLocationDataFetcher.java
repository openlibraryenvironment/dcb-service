...
public class CreateLocationDataFetcher implements DataFetcher<CompletableFuture<Location>> {
	...
	public CompletableFuture<Location> get(DataFetchingEnvironment env) {
		...
		Boolean isEnabledForPickupAnywhere = input_map.get("isEnabledForPickupAnywhere") !=null ? Boolean.valueOf(input_map.get("isEnabledForPickupAnywhere").toString()): null;
			...
			.flatMap(agency -> Mono.from(hostLmsRepository.findByCode(hostLmsCode))
				...
				.flatMap(hostLms -> {
					...
					Location location = Location.builder()
						...
						.type(type)
						.isPickup(isPickup)
						.isEnabledForPickupAnywhere(isEnabledForPickupAnywhere)
