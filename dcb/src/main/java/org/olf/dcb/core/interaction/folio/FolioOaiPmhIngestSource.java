...
/**
 * PLEASE NOTE: This file now super-classes the V2 of this. Ideally V2 would be renamed and the `2` removed so as to only have 1
 * file. I'm leaving this here with the code commented out so we can more easily revert if there are problems. There were changes added
 * into this file that were not in the Base OAI class so they have also been echoed in that class.
 * 
 * TODO: Remove V2 and refactor the code here.
 */
@Slf4j
@Prototype
@Replaces(FolioOaiPmhIngestSource2.class) // Funnel all client lookups through this bean
public class FolioOaiPmhIngestSource extends FolioOaiPmhIngestSource2 {
