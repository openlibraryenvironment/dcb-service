...
public class IntMessageService {
	private static final Map<String,String> mappings = Map.ofEntries(
		...
		Map.entry("PATRON_DELETED", "This borrower account appears to be linked to a patron that has been deleted in your library's system. Please contact your library for additional information."),
