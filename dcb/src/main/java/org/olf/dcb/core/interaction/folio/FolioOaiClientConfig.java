...
import io.micronaut.http.client.HttpVersionSelection.PlaintextMode;
...
public class FolioOaiClientConfig extends HttpClientConfiguration {
	...
	public void setReadTimeout(@Nullable Duration readTimeout) {
		defaultConfig.setReadTimeout(readTimeout);
	}
	...
	@Override
	public @NonNull
	PlaintextMode getPlaintextMode() {
		return defaultConfig.getPlaintextMode();
	}

	@Override
	public void setPlaintextMode(@NonNull PlaintextMode plaintextMode) {
