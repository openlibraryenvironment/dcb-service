...
@Transactional
public interface PostgresAgencyGroupRepository extends 
                                                ReactiveStreamsPageableRepository<AgencyGroup, UUID>, 
                                                ReactiveStreamsJpaSpecificationExecutor<AgencyGroup>,
                                                AgencyGroupRepository {
}
