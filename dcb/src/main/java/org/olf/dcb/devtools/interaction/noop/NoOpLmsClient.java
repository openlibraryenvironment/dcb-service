package org.olf.dcb.devtools.interaction.noop;
 ...
 */
@Prototype
public class NoOpLmsClient implements HostLmsClient, MarcIngestSource<OaiListRecordsMarcXML> {

	private static final Logger log = LoggerFactory.getLogger(NoOpLmsClient.class);

	private static final String UUID5_PREFIX = "ingest-source:noop-lms";
	private final ConversionService conversionService;
	private final HostLms lms;
	private final ProcessStateService processStateService;
	private final RawSourceRepository rawSourceRepository;

	public NoOpLmsClient(@Parameter HostLms lms, 
	...
	public HostLms getHostLms() {
        ...
        public List<HostLmsPropertyDefinition> getSettings() {
                return List.of(
                        new HostLmsPropertyDefinition("base-url", "Base URL Of NoOpLmsClient System", Boolean.TRUE, "URL" )
                );
        }
	...
	public Mono<String> updateItemStatus(String itemId, CanonicalItemState crs) {
		return Mono.just("NoOpLmsClient");
	}
