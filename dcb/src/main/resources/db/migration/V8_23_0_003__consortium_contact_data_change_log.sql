alter table consortium_contact add last_edited_by varchar(100);
alter table consortium_contact add reason varchar(100);
alter table consortium_contact add change_reference_url varchar(200);
alter table consortium_contact add change_category varchar(200);

-- This is to ensure we catch consortium_contact deletions in the data change log
...
CREATE TRIGGER data_change_log_trigger_delete_consortium_contact
BEFORE DELETE ON consortium_contact
