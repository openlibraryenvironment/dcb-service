...
BEGIN
 ...
 CREATE TRIGGER data_change_log_trigger_insert_update_consortium
 AFTER INSERT OR UPDATE ON consortium
 FOR EACH ROW EXECUTE FUNCTION audit_trigger();

 CREATE TRIGGER data_change_log_trigger_insert_update_functional_setting
  AFTER INSERT OR UPDATE ON functional_setting
  FOR EACH ROW EXECUTE FUNCTION audit_trigger();
