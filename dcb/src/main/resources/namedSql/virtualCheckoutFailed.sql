...
where pra.brief_description like 'Virtual checkout failed%' and
	  /* not pra.audit_data->>'Error' like '%Calendar timetable is absent for requested date%' and */
	  /*not pra.audit_data->>'Error' like '% invalid pin entered.%' and */
	  pra.from_status = 'LOANED' and
